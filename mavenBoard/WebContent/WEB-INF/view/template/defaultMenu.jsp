...
$(document).ready(function(){
	...
	$("div").children("ul").children(".menu").children("ul").hide();
    ...
    $(".menu>a").click(function(){
      ...
      $(this).next("a").next("ul").toggle();
		...
		if($(this).next("a").next("ul").css("display") == "none" || $(this).next("a").next("ul").css("display") == "block"){		
         	
			alert("123123");
         		
			if($(this).next("a").next("ul").children(".menu").children("ul").css("display") == "block"){
         			 
				alert("11");
      			 
         			$(this).next("a").next("ul").children(".menu").children("ul").toggle(); 
         			
         			 $(this).next("a").next("ul").children(".menu").next("li").children("ul").toggle();
         			
         		 }
         		 
         		 if($(this).next("a").next("ul").children(".menu").next("li").children("ul").css("display") == "block"){
		...
		if($(this).next("a").next("ul").children(".menu").children("ul").css("display") == "block" 
				|| $(this).next("a").next("ul").children(".menu").next("li").children("ul").css("display") == "block"){
			
			alert("15");
			
			 $(this).next("a").next("ul").children("li").children("ul").hide();  
			
			$(this).next("a").next("ul").children(".menu").next("li").children("ul").hide(); 
